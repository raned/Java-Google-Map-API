...
public class MapPane extends JPanel
{
    ...
    private double xlat=18.1824;
    private double xlong=-77.3218;
    private double step=1;
    private String yournav=null;
    private String secretkey="AIzaSyA-Y2n0AoEnL9nRQPTB9UdYG4Hp92eiDvw";
    public MapPane()
    {
                ...
                public void run(){
                   ...
                   // yournav=ImageIco.getIp();
                    try{
                        ...
                        if(yournav==null)
                            img.setImage(StreamIO.getMap("http://maps.googleapis.com/maps/api/staticmap?center="+xlat+","+xlong+"&zoom="+zoom+"&size=500x400&maptype="+typemap+"&sensor=true&key="+secretkey).getImage()); 
                        else
                            img.setImage(StreamIO.getMap("http://maps.googleapis.com/maps/api/staticmap?center="+xlat+","+xlong+"&zoom="+zoom+"&size=500x400&maptype="+typemap+"&sensor=true&key="+secretkey+"&markers=color:red%7Clabel:S%7C"+yournav).getImage()); 
